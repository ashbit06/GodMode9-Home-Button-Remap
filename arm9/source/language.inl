...
STRING(CLEAR_CLIPBOARD, "ZR - Clear Clipboard\n") // remapped from R
STRING(RESTORE_CLIPBOARD, "ZR - Restore Clipboard\n") // remapped from R
STRING(REBOOT_POWEROFF_HOME, "START - Reboot / [+R] Poweroff\nSELECT button for HOME menu") // remapped from home
...
STRING(CREATE_NEW_FILE_HERE_ENTER_SIZE_BELOW, "Create a new file here?\nEnter file size below.")
...
STRING(ETA_N_HOUR_N_MIN_N_SEC, "ETA %02lluh%02llum%02llus")
...
STRING(ERROR_SIGNATURE_CHECK_FAILED, "Error: Signature check failed")
STRING(USE_SIGNATURE_VERIFICATION, "Use signature verification?")
STRING(IGNORE_SIGNATURES, "Ignore signatures")
STRING(VERIFY_SIGNATURES, "Verify signatures")
STRING(STANDARD_CRYPTO, "Standard encryption")
STRING(ORIGINAL_CRYPTO, "Original encryption")
STRING(SELECT_TYPE_OF_ENCRYPTION, "Select type of encryption")
